...
export class SliderComponent implements OnInit {
  ...
  images = [
    ...
    {img:'../../../assets/slider/4.jpg',text:'Premium Assignment Help and Writing Services In UK - @30% Off - Best Price Guaranteed!',summary:'Get instant cheap assignment help & writing services from All subject experts. Treat Assignment Help offers reliable and A+ grades assignment help at 30% off.'},
